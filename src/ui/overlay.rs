...
pub fn draw_info_overlay(
    ...
    draw_text(&format!("Atoms: {} | Residues: {} | Theme: {} (Map: {} E:{} A:{})", atom_count, residue_count, theme_name, mapping_index, mapping_rotation_element, mapping_rotation_aa), 10.0, 20.0, 25.0, BLACK);
    ...
    draw_text(&format!("[ / ]: Alpha {:.1}", alpha), 10.0, 180.0, 20.0, GRAY);
