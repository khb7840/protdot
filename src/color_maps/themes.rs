...
pub fn create_builtin_themes() -> Vec<Theme> {
    ...
    themes.push(Theme {
        ...
        aa_types: generate_aa_types_from_palette(
            &myth_elements,
            &myth_aa_groups,
            colors[0],
            colors[4],
...
pub fn generate_aa_types_from_palette(
    elements: &HashMap<String, Color>,
    aa_groups: &HashMap<String, Color>,
